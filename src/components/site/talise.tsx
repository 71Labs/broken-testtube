...
function TalisePreview() {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-border bg-[#f3f5f1] p-8">
      <div
        className="pointer-events-none absolute inset-0 opacity-70"
        style={{ background: "radial-gradient(120% 90% at 70% 0%, rgba(88,173,62,0.14), transparent 60%)" }}
      />
      <div className="relative mx-auto flex h-[380px] max-w-sm items-end justify-center">
        ...
        >
          <Image src="/talise/send.png" alt="Talise send flow" width={1206} height={2622} sizes="150px" className="rounded-[1.3rem] border border-black/10 shadow-2xl" />
        </div>
        <div
        ...
        >
          <Image src="/talise/cheque.png" alt="Talise cheque link" width={1206} height={2622} sizes="150px" className="rounded-[1.3rem] border border-black/10 shadow-2xl" />
        </div>
        <div className="relative w-[172px]">
          <Image src="/talise/home.png" alt="Talise home screen" width={1206} height={2622} sizes="172px" priority className="rounded-[1.5rem] border border-black/10 shadow-2xl" />
        </div>
      </div>
    </div>
  );
